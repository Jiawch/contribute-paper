...
#         writer.add_summary(_sup_summaries, global_step=_global_step)
    ...
    global best
    if best:
        save_path = saver.save(sess, model_config["model_base_dir"] + os.path.sep + str(experiment_id) + os.path.sep + str(experiment_id), global_step=int(0))
    else:
        save_path = saver.save(sess, model_config["model_base_dir"] + os.path.sep + str(experiment_id) + os.path.sep + str(experiment_id), global_step=int(1))
