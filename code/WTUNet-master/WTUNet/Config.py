...
def cfg():
    # Base configuration
    model_config = {"musdb_path" : "/home/wuhao/tinglok/database/MUSDB18/", # SET MUSDB PATH HERE, AND SET CCMIXTER PATH IN CCMixter.xml
                    "estimates_path" : "/home/wuhao/tinglok/tmp/WTUnet_v2/Source_Estimate/", # SET THIS PATH TO WHERE YOU WANT SOURCE ESTIMATES PRODUCED BY THE TRAINED MODEL TO BE SAVED. Folder itself must exist!
                    "data_path" : "/home/wuhao/tinglok/WTUNet/data", # Set this to where the preprocessed dataset should be saved
